...
var filename = "input/map_forest01n.rel";
...
for(var i = 0; i < MapSectionData.length; i++){
  ...
  for(var k = 0; k < vlist.length; k++){
    out_model = util.format("out/%s_%d.obj", base, k);
    modf = fs.openSync(out_model, "w");

    console.log("VList %d", k);

module.exports = {
  ...
  read_xj_model : function (offset, fp,rot){
    ...
    if(model.polygon_entry_01_addr){
      ...
      var text_tmp = {
        unknown_06 : fp.read_dword() + 4,
        unknown_07 : fp.read_dword(),
        indice_list_addr : fp.read_dword(),
        num_indices : fp.read_dword()
      };

      if(text_tmp.unknown_07 == 4){
        text_tmp.unknown_06 += 16;
      }



      //var num = fp.read_dword();

      var poly = {};
      //poly.texture = model.polygon_01_texture;
      fp.seek_set(text_tmp.unknown_06);
      poly.texture = fp.read_dword();
      poly.list = [];
